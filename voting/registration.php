   ...
   <div class="container">
        ...
        <form action="register_data.php" method="POST" enctype="multipart/form-data">
            <div class="form">
                ...
                <label class="label" id="myid1"><sup class="req_symbol">*</sup>Cnic No:</label>
                <input type="text" name="idnum" placeholder="Enter Cnic Number" class="input" required>

                <label class="label" id="myid"><sup class="req_symbol">*</sup>Cnic:</label>
